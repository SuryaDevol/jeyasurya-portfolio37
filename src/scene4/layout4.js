...
export const CARDS = [
  { id: 'p01_timeless', title: 'AI CCTV Surveillance System',
    box: [213, 72, 384, 273], depth: 0.45,
    tint: [0.309, 0.334, 0.382] },
  { id: 'p02_game', title: '2D Endless Runner (Unity/C#)',
    box: [63, 251, 428, 269], depth: 0.25,
    tint: [0.249, 0.267, 0.295] },
  { id: 'p03_build', title: 'LegalScanAI Platform',
    box: [566, 41, 471, 288], depth: 0.6,
    tint: [0.414, 0.291, 0.291] },
  { id: 'p04_driven', title: 'Guardian Union: Detect the Unseen',
    box: [998, 95, 460, 377], depth: 0.45,
    tint: [0.322, 0.278, 0.261] },
  { id: 'p05_ideas', title: 'Neural Link in Human Brain',
    box: [394, 358, 232, 198], depth: 0.8,
    tint: [0.39, 0.303, 0.234] },
  { id: 'p06_sound', title: 'Flutter Mobile App Development',
    box: [568, 364, 173, 203], depth: 0.9,
    tint: [0.336, 0.324, 0.333] },
  { id: 'p07_food', title: 'Python Algorithms & Problem Solving',
    box: [698, 366, 211, 204], depth: 1.0,
    tint: [0.336, 0.243, 0.217] },
  { id: 'p08_travel', title: 'Android Studio Responsive UI',
    box: [844, 370, 195, 206], depth: 0.9,
    tint: [0.26, 0.32, 0.366] },
  { id: 'p09_space', title: 'OpenCV Computer Vision & Entity Tracking',
    box: [988, 364, 231, 208], depth: 0.8,
    tint: [0.336, 0.283, 0.269] },
  { id: 'p10_play', title: 'Software QA & End-to-End Testing',
    box: [1181, 251, 355, 242], depth: 0.3,
    tint: [0.448, 0.305, 0.235] },
  { id: 'p11_cleaner', title: 'Automated Security Alert Mechanism',
    box: [118, 467, 345, 243], depth: 0.1,
    tint: [0.311, 0.339, 0.263] },
  { id: 'p12_steps', title: 'NOVA 2K25 Best Project Award',
